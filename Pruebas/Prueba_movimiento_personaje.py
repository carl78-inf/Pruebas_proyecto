# Prueba movimiento del personaje
...
#Constructor---------------------------------------------------------------------------------------------------------------------#
    ...
    def setup(self):
        ...
        #self.player.sprite = arcade.Sprite(self.player_texture)
        ...
        self.score_text = arcade.Text(f"({self.player.pos_x}, {self.player.pos_y}, {self.player.pos_z})", x=0, y=20)
    ...
    def on_update(self, delta_time):
        ...
        if arcade.check_for_collision_with_list(
            self.player.sprite, self.scene["Don't Touch"]
        ):
            arcade.play_sound(self.gameover_sound)
            self.setup()

        # Check if the player got to the end of the level
        if self.player.sprite.center_x >= self.end_of_map:
